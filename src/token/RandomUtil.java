...
public class RandomUtil {
	...
	public static void main(String[] args) {
		System.out.println("返回一个定长的随机字符串(只包含大小写字母、数字):" + generateString(40));
		System.out
				.println("返回一个定长的随机纯字母字符串(只包含大小写字母):" + generateMixString(40));
		...
		System.out.println("生成一个定长的纯0字符串:" + generateZeroString(40));
